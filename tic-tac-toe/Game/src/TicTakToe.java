...
public class TicTakToe {
	...
	public static String player(String[][] table) { 
		System.out.println("enter a vaid empty place for your move");
		Scanner sc = new Scanner(System.in);
		String place = sc.next();
		switch(place) {
		  case "a":
			  if(table[0][0].equals(" ")){return table[0][0] = "x";}
			  else{return player(table);}
		  case "b":
			  if(table[0][1].equals(" ")){return table[0][1] = "x";}
			  else{return player(table);}
		  case "c":
			  if(table[0][2].equals(" ")){return table[0][2] = "x";}
			  else{return player(table);}
		  case "d":
			  if(table[1][0].equals(" ")){return table[1][0] = "x";}
			  else{return player(table);}
		  case "e":
			  if(table[1][1].equals(" ")){return table[1][1] = "x";}
			  else{return player(table);}
		  case "f":
			  if(table[1][2].equals(" ")){return table[1][2] = "x";}
			  else{return player(table);}
		  case "g":
			  if(table[2][0].equals(" ")){return table[2][0] = "x";}
			  else{return player(table);}
		  case "h":
			  if(table[2][1].equals(" ")){return table[2][1] = "x";}
			  else{return player(table);}
		  case "i":
			  if(table[2][2].equals(" ")){return table[2][2] = "x";}
			  else{return player(table);}
		  default:
			  return player(table);
		}		
	...
	public static String computer(String[][] table) {
		...
		switch(x) {
		  case 1:
			  if(table[0][0].equals(" ")){return table[0][0] = "o";}
			  else{computer(table);}
			  break;
		  case 2:
			  if(table[0][1].equals(" ")){return table[0][1] = "o";}
			  else{computer(table);}	
			  break;
		  case 3:
			  if(table[0][2].equals(" ")){return table[0][2] = "o";}
			  else{computer(table);}
			  break;
		  case 4:
			  if(table[1][0].equals(" ")){return table[1][0] = "o";}
			  else{computer(table);}
			  break;
		  case 5:
			  if(table[1][1].equals(" ")){return table[1][1] = "o";}
			  else{computer(table);}
			  break;
		  case 6:
			  if(table[1][2].equals(" ")){return table[1][2] = "o";}
			  else{computer(table);}
			  break;
		  case 7:
			  if(table[2][0].equals(" ")){return table[2][0] = "o";}
			  else{computer(table);}
			  break;
		  case 8:
			  if(table[2][1].equals(" ")){return table[2][1] = "o";}
			  else{computer(table);}
			  break;
		  case 9:
			  if(table[2][2].equals(" ")){return table[2][2] = "o";}
			  else{computer(table);}
		}
		return null;
	}
